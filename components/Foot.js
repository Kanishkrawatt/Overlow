...
function Foot() {
  return (
    <div className="mt-40" >
        <footer className="text-center bg-[#edece8] text-black">
    ...
    <div className="flex justify-center mb-6">
      ...
      <a href="#!" type="button" className="rounded-full border-2 border-black text-back leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1">
        <svg aria-hidden="true"
        focusable="false"
        data-prefix="fab"
